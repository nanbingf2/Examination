...
<body>
						...
						<div class="row">
							...
							<form class="bs-example bs-example-form col-md-5" role="form" style="margin: 20px 0 10px 0;" action="showCourse" id="form1" method="post">
								<div class="input-group">
									<input type="text" class="form-control" placeholder="请输入课程名称" value="${coursename}" name="coursename">
							...
							<c:forEach  items="${courseList}" var="item">
								<tr>
									...
									<td>
										...
										<button class="btn btn-default btn-xs btn-danger btn-primary" onClick="confirmd(${item.courseid})">删除</button>
										<!--弹出框-->
									</td>
								</tr>
							</c:forEach>
	...
	<script type="text/javascript">
		...
		function confirmd(id) {
			var msg = "您真的确定要删除吗？！";
			if (confirm(msg)==true){
				location.href="deleteCourse?id="+id;
			}else{
				return false;
			}
		};
